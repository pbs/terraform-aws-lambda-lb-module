...
```hcl
github.com/pbs/terraform-aws-lambda-lb-module?ref=0.0.15
```
...
```hcl
module "lambda_lb" {
  source = "github.com/pbs/terraform-aws-lambda-lb-module?ref=0.0.15"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lambda"></a> [lambda](#module\_lambda) | github.com/pbs/terraform-aws-lambda-module | 1.3.24 |
