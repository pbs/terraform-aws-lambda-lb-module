...
```hcl
github.com/pbs/terraform-aws-lambda-lb-module?ref=0.0.39
```
...
```hcl
module "lambda_lb" {
  source = "github.com/pbs/terraform-aws-lambda-lb-module?ref=0.0.39"
...
| <a name="module_lb_egress"></a> [lb\_egress](#module\_lb\_egress) | github.com/pbs/terraform-aws-sg-rule-module | 0.0.22 |
...
| <a name="module_lb_http_ingress_sgs"></a> [lb\_http\_ingress\_sgs](#module\_lb\_http\_ingress\_sgs) | github.com/pbs/terraform-aws-sg-rule-module | 0.0.22 |
| <a name="module_lb_https_ingress_cidrs"></a> [lb\_https\_ingress\_cidrs](#module\_lb\_https\_ingress\_cidrs) | github.com/pbs/terraform-aws-sg-rule-module | 0.0.22 |
