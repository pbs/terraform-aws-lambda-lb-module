...
```hcl
github.com/pbs/terraform-aws-lambda-lb-module?ref=0.0.14
```
...
```hcl
module "lambda_lb" {
  source = "github.com/pbs/terraform-aws-lambda-lb-module?ref=0.0.14"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lambda"></a> [lambda](#module\_lambda) | github.com/pbs/terraform-aws-lambda-module | 1.3.20 |
| <a name="module_lambda_permission"></a> [lambda\_permission](#module\_lambda\_permission) | github.com/pbs/terraform-aws-lambda-permission-module | 0.0.4 |
| <a name="module_lb_egress"></a> [lb\_egress](#module\_lb\_egress) | github.com/pbs/terraform-aws-sg-rule-module | 0.0.13 |
| <a name="module_lb_http_ingress_cidrs"></a> [lb\_http\_ingress\_cidrs](#module\_lb\_http\_ingress\_cidrs) | github.com/pbs/terraform-aws-sg-rule-module | 0.0.13 |
...
| <a name="module_lb_https_ingress_cidrs"></a> [lb\_https\_ingress\_cidrs](#module\_lb\_https\_ingress\_cidrs) | github.com/pbs/terraform-aws-sg-rule-module | 0.0.13 |
